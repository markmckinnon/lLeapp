...
from scripts.lleapfuncs import logfunc, tsv, timeline, is_platform_windows, open_sqlite_db_readonly, does_column_exist_in_db
...
def get_contacts(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        if not os.path.basename(file_name) == 'contacts2.db' and \
           not os.path.basename(file_name) == 'profile.db': # skip -journal and other files
            continue
