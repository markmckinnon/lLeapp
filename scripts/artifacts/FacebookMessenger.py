...
from scripts.lleapfuncs import logfunc, tsv, timeline, is_platform_windows, get_next_unused_name, open_sqlite_db_readonly
...
def get_FacebookMessenger(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        if (file_found.lower().endswith('cookies')):
            get_appCookies(file_found, report_folder, seeker, wrap_text, "Facebook")
