...
def get_docker_config(files_found, report_folder, seeker, wrap_text):
    ...
    if usageentries > 0:
        ...
        report.add_script()
        data_headers = ('image_name', 'container_id', 'image_id', 'os', 'working_dir', 'entry_point', 'created_date', 'start_date', 'finished_date', 'running', 'paused', 'mount_id', 'upper_id', 'log_path', 'exposed_ports')
